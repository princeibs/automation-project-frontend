...
const AdminSupervisorDetails = () => {
    ...
    const getStaffDetails = async () => {
        try {
          setLoading(true)
          const res = await axios.get(`${baseUrl}/admin/supervisor-details/${id}`);
                    ...
                    <table class="w-full text-sm text-left text-black mb-12">
                        <tbody>
                            ...
                            <tr class="border-b border-gray-700">
                                ...
                                <td class="px-6 py-4 w-[30%] bg-white text">
                                    {MAX_STUDENT_TO_SUPERVISE - userDetails.students?.length}
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
export default AdminSupervisorDetails