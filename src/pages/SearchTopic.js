  ...
  return (
   <div className=''>
    ...
    <form className='w-[50rem] m-auto' onSubmit={formSubmit}>
      ...
      <button type="submit" class="w-full h-[3rem] mt-[2rem] text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Search</button>
    </form>
   </div>
  )
}
                ...
                <div className='border rounded p-4 w-[50rem] bg-yellow-50'>
                  <div className='flex justify-between items-start mb-5 mt-2 mr-2'>
                    ...
                    <div className='flex items-center justify-between gap-3'>
                      ...
                      <CopyIcon onClick={() => copy({title: topic.title, description: topic.description})}/>
                    </div>
                  </div>
...
const SearchTopic = () => {
    ...
    return (
        <>
            {display == 1 && <Search handleSearch={handleSearch}/>}
